...
sed -z 's/ x=/,/g' data.txt > formatted.txt
sed -i -z -e 's/,y=/,/g' formatted.txt
sed -i -z -e 's/,z=/,/g' formatted.txt
sed -i -z -e 's/\.\./,/g' formatted.txt

sed -z 's/ x=/,/g' small-data.txt > small-formatted.txt
sed -i -z -e 's/,y=/,/g' small-formatted.txt
sed -i -z -e 's/,z=/,/g' small-formatted.txt
